...
$query=mysqli_query($conn,"select ID from tbladmin where ID='$admid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($conn,"update tbladmin set Password='$newpassword' where ID='$admid'");
