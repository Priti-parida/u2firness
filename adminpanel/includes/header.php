            ...
            <li class="dropdown dropdown-user nav-item">
              <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                <span class="mr-1">Hello,
                  ...
                  <?php
$admid=$_SESSION['aid'];
$ret=mysqli_query($conn,"select username from tbladmin where ID='$admid'");
...
<?php $qury=mysqli_query($conn,"SELECT  tbladmapplications.ID as appid,tbluser.FirstName,tbladmapplications.CourseApplieddate from tbladmapplications join tbluser on tbluser.ID=tbladmapplications.UserId where tbladmapplications.AdminStatus is null");
