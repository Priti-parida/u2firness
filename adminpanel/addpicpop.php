...
if (strlen($_SESSION['aid']==0)) {
  header('location:logout.php');
    ...
    //echo "INSERT INTO images set img_name='$new'"; die;
        ...
        mysqli_query($conn,"INSERT INTO popimg set img_name='$new'");
    }
    echo "<script>location='addpicpop.php'</script>";
      ...
      {
        $rid=$_GET['delnotid'];
      $query=mysqli_query($conn,"delete from popimg where id='$rid'");
	...
	<?php
     ...
     if(mysqli_num_rows($result)>0){
       ...
       <?php 
			...
			?>
			<img src="updpop/<?php echo $image; ?>" width="300" height="250">
			<a href="addpicpop.php?delnotid=<?php echo $fetch['id'];?>" title="delete images"onClick="return confirm('Do you really want to delete');">DELETE</a>
			<?php }} }?>
